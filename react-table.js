...
function normalizeComponent(Comp, props) {
  ...
  if (reactIs_2(Comp) || typeof Comp === 'string') {
    return Comp;
  } else if (reactIs_1(Comp)) {
    return React__default.createElement(Comp, props);
  }
...
var ReactTable = function (_Methods) {
  ...
  function ReactTable(props) {
    ...
    var _this = possibleConstructorReturn(this, (ReactTable.__proto__ || Object.getPrototypeOf(ReactTable)).call(this, props));
